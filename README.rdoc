...
Search for a movie:
    ...
    # => {:amazon=>[], :hulu=>[], :itunes=>[{"title"=>"The Prestige", "url"=>"https://itunes.apple.com/us/movie/the-prestige/id209960866?uo=4", "price"=>9.99}], :netflix=>[{"title"=>"The Prestige", "url"=>"http://www.netflix.com/Movie/The_Prestige/70047095", "instant"=>false}]}
...
Only want to search Netflix and iTunes?

    m = MWhich::Client.new(:services => [:netflix, :itunes])
    m.search("Lost in Translation")
    # => {:itunes=>[{"title"=>"Lost In Translation", "url"=>"https://itunes.apple.com/us/movie/lost-in-translation/id293296135?uo=4", "price"=>9.99}, {"title"=>"Eternal Sunshine of the Spotless Mind", "url"=>"https://itunes.apple.com/us/movie/eternal-sunshine-spotless/id303440550?uo=4", "price"=>9.99}, {"title"=>"Traffic", "url"=>"https://itunes.apple.com/us/movie/traffic/id299862577?uo=4", "price"=>9.99}], :netflix=>[{"title"=>"Lost in Translation", "url"=>"http://www.netflix.com/Movie/Lost_in_Translation/60031214", "instant"=>true}]}
